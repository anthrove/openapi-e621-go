...
type PostEventsAPISearchPostEventsRequest struct {
	ctx               context.Context
...
func (r PostEventsAPISearchPostEventsRequest) Limit(limit int32) PostEventsAPISearchPostEventsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r PostEventsAPISearchPostEventsRequest) Page(page int32) PostEventsAPISearchPostEventsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r PostEventsAPISearchPostEventsRequest) SearchId(searchId int32) PostEventsAPISearchPostEventsRequest {
	r.searchId = &searchId
	return r
}

func (r PostEventsAPISearchPostEventsRequest) SearchOrder(searchOrder string) PostEventsAPISearchPostEventsRequest {
...
func (r PostEventsAPISearchPostEventsRequest) SearchCreatorName(searchCreatorName string) PostEventsAPISearchPostEventsRequest {
	r.searchCreatorName = &searchCreatorName
	return r
}

func (r PostEventsAPISearchPostEventsRequest) SearchAction(searchAction PostEventActions) PostEventsAPISearchPostEventsRequest {
	r.searchAction = &searchAction
	return r
}

func (r PostEventsAPISearchPostEventsRequest) Execute() (*SearchPostEvents200Response, *http.Response, error) {
...
SearchPostEvents Search Post Events
	...
	@return PostEventsAPISearchPostEventsRequest
*/
func (a *PostEventsAPIService) SearchPostEvents(ctx context.Context) PostEventsAPISearchPostEventsRequest {
	return PostEventsAPISearchPostEventsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PostEventsAPIService) SearchPostEventsExecute(r PostEventsAPISearchPostEventsRequest) (*SearchPostEvents200Response, *http.Response, error) {
	var (

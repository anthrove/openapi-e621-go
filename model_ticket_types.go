...
// List of TicketTypes
const (
	TICKETTYPES_BLIP    TicketTypes = "blip"
	TICKETTYPES_COMMENT TicketTypes = "comment"
	TICKETTYPES_DMAIL   TicketTypes = "dmail"
	TICKETTYPES_FORUM   TicketTypes = "forum"
	TICKETTYPES_POOL    TicketTypes = "pool"
	TICKETTYPES_POST    TicketTypes = "post"
	TICKETTYPES_SET     TicketTypes = "set"
	TICKETTYPES_USER    TicketTypes = "user"
	TICKETTYPES_WIKI    TicketTypes = "wiki"
)

...
type ApiEditCurrentUserRequest struct {
	ctx context.Context
...
func (r ApiEditCurrentUserRequest) UserCommentThreshold(userCommentThreshold float32) ApiEditCurrentUserRequest {
	r.userCommentThreshold = &userCommentThreshold
	return r
}

func (r ApiEditCurrentUserRequest) UserDefaultImageSize(userDefaultImageSize string) ApiEditCurrentUserRequest {
	r.userDefaultImageSize = &userDefaultImageSize
	return r
}

func (r ApiEditCurrentUserRequest) UserFavoriteTags(userFavoriteTags string) ApiEditCurrentUserRequest {
	r.userFavoriteTags = &userFavoriteTags
	return r
}

func (r ApiEditCurrentUserRequest) UserBlacklistedTags(userBlacklistedTags string) ApiEditCurrentUserRequest {
	r.userBlacklistedTags = &userBlacklistedTags
	return r
}

// https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
func (r ApiEditCurrentUserRequest) UserTimeZone(userTimeZone string) ApiEditCurrentUserRequest {
	r.userTimeZone = &userTimeZone
	return r
}

func (r ApiEditCurrentUserRequest) UserPerPage(userPerPage float32) ApiEditCurrentUserRequest {
	r.userPerPage = &userPerPage
	return r
}

func (r ApiEditCurrentUserRequest) UserCustomStyle(userCustomStyle string) ApiEditCurrentUserRequest {
	r.userCustomStyle = &userCustomStyle
	return r
}

func (r ApiEditCurrentUserRequest) UserDescriptionCollapsedInitially(userDescriptionCollapsedInitially bool) ApiEditCurrentUserRequest {
	r.userDescriptionCollapsedInitially = &userDescriptionCollapsedInitially
	return r
}

func (r ApiEditCurrentUserRequest) UserHideComments(userHideComments bool) ApiEditCurrentUserRequest {
	r.userHideComments = &userHideComments
	return r
}

func (r ApiEditCurrentUserRequest) UserReceiveEmailNotifications(userReceiveEmailNotifications bool) ApiEditCurrentUserRequest {
	r.userReceiveEmailNotifications = &userReceiveEmailNotifications
	return r
}

func (r ApiEditCurrentUserRequest) UserEnableKeyboardNavigation(userEnableKeyboardNavigation bool) ApiEditCurrentUserRequest {
	r.userEnableKeyboardNavigation = &userEnableKeyboardNavigation
	return r
}

func (r ApiEditCurrentUserRequest) UserEnablePrivacyMode(userEnablePrivacyMode bool) ApiEditCurrentUserRequest {
	r.userEnablePrivacyMode = &userEnablePrivacyMode
	return r
}

func (r ApiEditCurrentUserRequest) UserDisableUserDmails(userDisableUserDmails bool) ApiEditCurrentUserRequest {
	r.userDisableUserDmails = &userDisableUserDmails
	return r
}

func (r ApiEditCurrentUserRequest) UserBlacklistUsers(userBlacklistUsers bool) ApiEditCurrentUserRequest {
	r.userBlacklistUsers = &userBlacklistUsers
	return r
}

func (r ApiEditCurrentUserRequest) UserShowPostStatistics(userShowPostStatistics bool) ApiEditCurrentUserRequest {
	r.userShowPostStatistics = &userShowPostStatistics
	return r
}

func (r ApiEditCurrentUserRequest) UserStyleUsernames(userStyleUsernames bool) ApiEditCurrentUserRequest {
	r.userStyleUsernames = &userStyleUsernames
	return r
}

func (r ApiEditCurrentUserRequest) UserShowHiddenComments(userShowHiddenComments bool) ApiEditCurrentUserRequest {
	r.userShowHiddenComments = &userShowHiddenComments
	return r
}

func (r ApiEditCurrentUserRequest) UserEnableAutocomplete(userEnableAutocomplete bool) ApiEditCurrentUserRequest {
	r.userEnableAutocomplete = &userEnableAutocomplete
	return r
}

func (r ApiEditCurrentUserRequest) UserDisableCroppedThumbnails(userDisableCroppedThumbnails bool) ApiEditCurrentUserRequest {
	r.userDisableCroppedThumbnails = &userDisableCroppedThumbnails
	return r
}

func (r ApiEditCurrentUserRequest) UserEnableSafeMode(userEnableSafeMode bool) ApiEditCurrentUserRequest {
	r.userEnableSafeMode = &userEnableSafeMode
	return r
}

func (r ApiEditCurrentUserRequest) UserDisableResponsiveMode(userDisableResponsiveMode bool) ApiEditCurrentUserRequest {
	r.userDisableResponsiveMode = &userDisableResponsiveMode
	return r
}

func (r ApiEditCurrentUserRequest) UserDmailFilterAttributesId(userDmailFilterAttributesId float32) ApiEditCurrentUserRequest {
	r.userDmailFilterAttributesId = &userDmailFilterAttributesId
	return r
}

func (r ApiEditCurrentUserRequest) UserDmailFilterAttributesWords(userDmailFilterAttributesWords string) ApiEditCurrentUserRequest {
	r.userDmailFilterAttributesWords = &userDmailFilterAttributesWords
	return r
}

func (r ApiEditCurrentUserRequest) UserProfileAbout(userProfileAbout string) ApiEditCurrentUserRequest {
	r.userProfileAbout = &userProfileAbout
	return r
}

func (r ApiEditCurrentUserRequest) UserProfileArtinfo(userProfileArtinfo string) ApiEditCurrentUserRequest {
	r.userProfileArtinfo = &userProfileArtinfo
	return r
}

func (r ApiEditCurrentUserRequest) UserAvatarId(userAvatarId float32) ApiEditCurrentUserRequest {
	r.userAvatarId = &userAvatarId
	return r
}

// You must have uploaded at least 10 posts.
func (r ApiEditCurrentUserRequest) UserEnableCompactUploader(userEnableCompactUploader bool) ApiEditCurrentUserRequest {
	r.userEnableCompactUploader = &userEnableCompactUploader
	return r
}

func (r ApiEditCurrentUserRequest) Execute() (*http.Response, error) {
...
EditCurrentUser Edit Current User
 ...
 @return ApiEditCurrentUserRequest
*/
func (a *UsersAPIService) EditCurrentUser(ctx context.Context, id float32) ApiEditCurrentUserRequest {
	return ApiEditCurrentUserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *UsersAPIService) EditCurrentUserExecute(r ApiEditCurrentUserRequest) (*http.Response, error) {
	var (
...
type ApiFixUserCountsRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
}

func (r ApiFixUserCountsRequest) Execute() (*http.Response, error) {
...
FixUserCounts Fix User Counts
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFixUserCountsRequest
*/
func (a *UsersAPIService) FixUserCounts(ctx context.Context) ApiFixUserCountsRequest {
	return ApiFixUserCountsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *UsersAPIService) FixUserCountsExecute(r ApiFixUserCountsRequest) (*http.Response, error) {
	var (
...
// Execute executes the request
//  @return CurrentUser
func (a *UsersAPIService) GetCurrentUserExecute(r ApiGetCurrentUserRequest) (*CurrentUser, *http.Response, error) {
	var (
...
*/
func (a *UsersAPIService) GetUser(ctx context.Context, id float32) ApiGetUserRequest {
	return ApiGetUserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (r ApiSearchUsersRequest) Limit(limit float32) ApiSearchUsersRequest {
	r.limit = &limit
	return r
}
...
func (r ApiSearchUsersRequest) SearchId(searchId float32) ApiSearchUsersRequest {
	r.searchId = &searchId
	return r
}
...
func (r ApiSearchUsersRequest) SearchIpAddr(searchIpAddr string) ApiSearchUsersRequest {
	r.searchIpAddr = &searchIpAddr
	return r
}

func (r ApiSearchUsersRequest) SearchOrder(searchOrder string) ApiSearchUsersRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchUsersRequest) SearchNameMatches(searchNameMatches string) ApiSearchUsersRequest {
	r.searchNameMatches = &searchNameMatches
	return r
}

func (r ApiSearchUsersRequest) SearchAboutMe(searchAboutMe string) ApiSearchUsersRequest {
	r.searchAboutMe = &searchAboutMe
	return r
}

func (r ApiSearchUsersRequest) SearchAvatarId(searchAvatarId float32) ApiSearchUsersRequest {
	r.searchAvatarId = &searchAvatarId
	return r
}

func (r ApiSearchUsersRequest) SearchLevel(searchLevel float32) ApiSearchUsersRequest {
	r.searchLevel = &searchLevel
	return r
}

func (r ApiSearchUsersRequest) SearchMinLevel(searchMinLevel float32) ApiSearchUsersRequest {
	r.searchMinLevel = &searchMinLevel
	return r
}

func (r ApiSearchUsersRequest) SearchMaxLevel(searchMaxLevel float32) ApiSearchUsersRequest {
	r.searchMaxLevel = &searchMaxLevel
	return r
}

func (r ApiSearchUsersRequest) SearchCanUploadFree(searchCanUploadFree bool) ApiSearchUsersRequest {
	r.searchCanUploadFree = &searchCanUploadFree
	return r
}

func (r ApiSearchUsersRequest) SearchCanApprovePosts(searchCanApprovePosts bool) ApiSearchUsersRequest {
	r.searchCanApprovePosts = &searchCanApprovePosts
	return r
}

// You must be Admin+.
func (r ApiSearchUsersRequest) SearchEmailMatches(searchEmailMatches string) ApiSearchUsersRequest {
	r.searchEmailMatches = &searchEmailMatches
	return r
}

func (r ApiSearchUsersRequest) Execute() ([]SearchUsers200ResponseInner, *http.Response, error) {
...
func (a *UsersAPIService) SearchUsersExecute(r ApiSearchUsersRequest) ([]SearchUsers200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile

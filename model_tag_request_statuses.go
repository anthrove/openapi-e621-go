...
const (
	ACTIVE TagRequestStatuses = "active"
	DELETED TagRequestStatuses = "deleted"
	PROCESSING TagRequestStatuses = "processing"
	QUEUED TagRequestStatuses = "queued"
	RETIRED TagRequestStatuses = "retired"
	ERROR TagRequestStatuses = "error"
	PENDING TagRequestStatuses = "pending"
)

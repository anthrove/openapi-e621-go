...
type ApiCreateEmailBlacklistRequest struct {
	ctx context.Context
...
func (r ApiCreateEmailBlacklistRequest) EmailBlacklistDomain(emailBlacklistDomain string) ApiCreateEmailBlacklistRequest {
	r.emailBlacklistDomain = &emailBlacklistDomain
	return r
}

func (r ApiCreateEmailBlacklistRequest) EmailBlacklistReason(emailBlacklistReason string) ApiCreateEmailBlacklistRequest {
	r.emailBlacklistReason = &emailBlacklistReason
	return r
}

func (r ApiCreateEmailBlacklistRequest) Execute() (*EmailBlacklist, *http.Response, error) {
...
You must be Admin+.
 ...
 @return ApiCreateEmailBlacklistRequest
*/
func (a *EmailBlacklistsAPIService) CreateEmailBlacklist(ctx context.Context) ApiCreateEmailBlacklistRequest {
	return ApiCreateEmailBlacklistRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EmailBlacklistsAPIService) CreateEmailBlacklistExecute(r ApiCreateEmailBlacklistRequest) (*EmailBlacklist, *http.Response, error) {
	var (
...
type ApiDeleteEmailBlacklistRequest struct {
	ctx context.Context
	ApiService *EmailBlacklistsAPIService
	id float32
}

func (r ApiDeleteEmailBlacklistRequest) Execute() (*http.Response, error) {
...
You must be Admin+.
 ...
 @return ApiDeleteEmailBlacklistRequest
*/
func (a *EmailBlacklistsAPIService) DeleteEmailBlacklist(ctx context.Context, id float32) ApiDeleteEmailBlacklistRequest {
	return ApiDeleteEmailBlacklistRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *EmailBlacklistsAPIService) DeleteEmailBlacklistExecute(r ApiDeleteEmailBlacklistRequest) (*http.Response, error) {
	var (
...
type ApiSearchEmailBlacklistsRequest struct {
	ctx context.Context
	ApiService *EmailBlacklistsAPIService
	limit *float32
	page *float32
...
func (r ApiSearchEmailBlacklistsRequest) Limit(limit float32) ApiSearchEmailBlacklistsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchEmailBlacklistsRequest) Page(page float32) ApiSearchEmailBlacklistsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchEmailBlacklistsRequest) SearchId(searchId float32) ApiSearchEmailBlacklistsRequest {
	r.searchId = &searchId
	return r
}

func (r ApiSearchEmailBlacklistsRequest) SearchOrder(searchOrder string) ApiSearchEmailBlacklistsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchEmailBlacklistsRequest) SearchDomain(searchDomain string) ApiSearchEmailBlacklistsRequest {
	r.searchDomain = &searchDomain
	return r
}

func (r ApiSearchEmailBlacklistsRequest) SearchReason(searchReason string) ApiSearchEmailBlacklistsRequest {
	r.searchReason = &searchReason
	return r
}

func (r ApiSearchEmailBlacklistsRequest) Execute() (*SearchEmailBlacklists200Response, *http.Response, error) {
...
You must be Admin+. When no results are found, an object with an `email_blacklists` key is returned.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchEmailBlacklistsRequest
*/
func (a *EmailBlacklistsAPIService) SearchEmailBlacklists(ctx context.Context) ApiSearchEmailBlacklistsRequest {
	return ApiSearchEmailBlacklistsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EmailBlacklistsAPIService) SearchEmailBlacklistsExecute(r ApiSearchEmailBlacklistsRequest) (*SearchEmailBlacklists200Response, *http.Response, error) {
	var (

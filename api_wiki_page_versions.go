...
type ApiGetWikiPageVersionRequest struct {
	ctx context.Context
	ApiService *WikiPageVersionsAPIService
	id float32
}

func (r ApiGetWikiPageVersionRequest) Execute() (*WikiPageVersion, *http.Response, error) {
...
GetWikiPageVersion Get Wiki Page Version
 ...
 @return ApiGetWikiPageVersionRequest
*/
func (a *WikiPageVersionsAPIService) GetWikiPageVersion(ctx context.Context, id float32) ApiGetWikiPageVersionRequest {
	return ApiGetWikiPageVersionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *WikiPageVersionsAPIService) GetWikiPageVersionExecute(r ApiGetWikiPageVersionRequest) (*WikiPageVersion, *http.Response, error) {
	var (
...
type ApiSearchWikiPageVersionsRequest struct {
	ctx context.Context
	ApiService *WikiPageVersionsAPIService
	limit *float32
	page *float32
...
func (r ApiSearchWikiPageVersionsRequest) Limit(limit float32) ApiSearchWikiPageVersionsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchWikiPageVersionsRequest) Page(page float32) ApiSearchWikiPageVersionsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchWikiPageVersionsRequest) SearchId(searchId float32) ApiSearchWikiPageVersionsRequest {
	r.searchId = &searchId
	return r
}
...
func (r ApiSearchWikiPageVersionsRequest) SearchIpAddr(searchIpAddr string) ApiSearchWikiPageVersionsRequest {
	r.searchIpAddr = &searchIpAddr
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchOrder(searchOrder string) ApiSearchWikiPageVersionsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchUpdaterId(searchUpdaterId float32) ApiSearchWikiPageVersionsRequest {
	r.searchUpdaterId = &searchUpdaterId
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchUpdaterName(searchUpdaterName string) ApiSearchWikiPageVersionsRequest {
	r.searchUpdaterName = &searchUpdaterName
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchWikiPageId(searchWikiPageId float32) ApiSearchWikiPageVersionsRequest {
	r.searchWikiPageId = &searchWikiPageId
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchTitle(searchTitle string) ApiSearchWikiPageVersionsRequest {
	r.searchTitle = &searchTitle
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchBody(searchBody string) ApiSearchWikiPageVersionsRequest {
	r.searchBody = &searchBody
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchIsLocked(searchIsLocked bool) ApiSearchWikiPageVersionsRequest {
	r.searchIsLocked = &searchIsLocked
	return r
}

func (r ApiSearchWikiPageVersionsRequest) SearchIsDeleted(searchIsDeleted bool) ApiSearchWikiPageVersionsRequest {
	r.searchIsDeleted = &searchIsDeleted
	return r
}

func (r ApiSearchWikiPageVersionsRequest) Execute() (*SearchWikiPageVersions200Response, *http.Response, error) {
...
When no results are found, an object with an `wiki_page_versions` key is returned.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchWikiPageVersionsRequest
*/
func (a *WikiPageVersionsAPIService) SearchWikiPageVersions(ctx context.Context) ApiSearchWikiPageVersionsRequest {
	return ApiSearchWikiPageVersionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WikiPageVersionsAPIService) SearchWikiPageVersionsExecute(r ApiSearchWikiPageVersionsRequest) (*SearchWikiPageVersions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile

...
type FavoritesAPIAddFavoriteRequest struct {
	ctx                context.Context
	ApiService         *FavoritesAPIService
	addFavoriteRequest *AddFavoriteRequest
}

func (r FavoritesAPIAddFavoriteRequest) AddFavoriteRequest(addFavoriteRequest AddFavoriteRequest) FavoritesAPIAddFavoriteRequest {
	r.addFavoriteRequest = &addFavoriteRequest
	return r
}

func (r FavoritesAPIAddFavoriteRequest) Execute() (*AddFavorite201Response, *http.Response, error) {
...
AddFavorite Add Favorite
	...
	@return FavoritesAPIAddFavoriteRequest
*/
func (a *FavoritesAPIService) AddFavorite(ctx context.Context) FavoritesAPIAddFavoriteRequest {
	return FavoritesAPIAddFavoriteRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *FavoritesAPIService) AddFavoriteExecute(r FavoritesAPIAddFavoriteRequest) (*AddFavorite201Response, *http.Response, error) {
	var (
...
type FavoritesAPIListFavoritesRequest struct {
	ctx        context.Context
	ApiService *FavoritesAPIService
	limit      *int32
	page       *int32
...
func (r FavoritesAPIListFavoritesRequest) Limit(limit int32) FavoritesAPIListFavoritesRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r FavoritesAPIListFavoritesRequest) Page(page int32) FavoritesAPIListFavoritesRequest {
	r.page = &page
	return r
}
...
func (r FavoritesAPIListFavoritesRequest) Execute() (*ListFavorites200Response, *http.Response, error) {
...
ListFavorites List Favorites
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return FavoritesAPIListFavoritesRequest
*/
func (a *FavoritesAPIService) ListFavorites(ctx context.Context) FavoritesAPIListFavoritesRequest {
	return FavoritesAPIListFavoritesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *FavoritesAPIService) ListFavoritesExecute(r FavoritesAPIListFavoritesRequest) (*ListFavorites200Response, *http.Response, error) {
	var (
...
// Execute executes the request
func (a *FavoritesAPIService) RemoveFavoriteExecute(r FavoritesAPIRemoveFavoriteRequest) (*http.Response, error) {
	var (

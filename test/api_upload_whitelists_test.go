...
func Test_openapi_UploadWhitelistsAPIService(t *testing.T) {
	...
	t.Run("Test UploadWhitelistsAPIService CreateUploadWhitelist", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.UploadWhitelistsAPI.CreateUploadWhitelist(context.Background()).Execute()

...
*/
func (a *PostApprovalsAPIService) ApprovePost(ctx context.Context) ApiApprovePostRequest {
	return ApiApprovePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PostApprovalsAPIService) ApprovePostExecute(r ApiApprovePostRequest) (*http.Response, error) {
	var (
...
type ApiSearchPostApprovalsRequest struct {
	ctx context.Context
	ApiService *PostApprovalsAPIService
	limit *float32
	page *float32
...
func (r ApiSearchPostApprovalsRequest) Limit(limit float32) ApiSearchPostApprovalsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchPostApprovalsRequest) Page(page float32) ApiSearchPostApprovalsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchPostApprovalsRequest) SearchId(searchId float32) ApiSearchPostApprovalsRequest {
	r.searchId = &searchId
	return r
}

func (r ApiSearchPostApprovalsRequest) SearchOrder(searchOrder string) ApiSearchPostApprovalsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchPostApprovalsRequest) SearchPostTagsMatch(searchPostTagsMatch string) ApiSearchPostApprovalsRequest {
	r.searchPostTagsMatch = &searchPostTagsMatch
	return r
}

func (r ApiSearchPostApprovalsRequest) SearchUserId(searchUserId float32) ApiSearchPostApprovalsRequest {
	r.searchUserId = &searchUserId
	return r
}

func (r ApiSearchPostApprovalsRequest) SearchUserName(searchUserName string) ApiSearchPostApprovalsRequest {
	r.searchUserName = &searchUserName
	return r
}

func (r ApiSearchPostApprovalsRequest) SearchPostId(searchPostId float32) ApiSearchPostApprovalsRequest {
	r.searchPostId = &searchPostId
	return r
}

func (r ApiSearchPostApprovalsRequest) Execute() (*SearchPostApprovals200Response, *http.Response, error) {
...
When no results are found, an object with an `post_approvals` key is returned.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchPostApprovalsRequest
*/
func (a *PostApprovalsAPIService) SearchPostApprovals(ctx context.Context) ApiSearchPostApprovalsRequest {
	return ApiSearchPostApprovalsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PostApprovalsAPIService) SearchPostApprovalsExecute(r ApiSearchPostApprovalsRequest) (*SearchPostApprovals200Response, *http.Response, error) {
	var (
...
*/
func (a *PostApprovalsAPIService) UnapprovePost(ctx context.Context) ApiUnapprovePostRequest {
	return ApiUnapprovePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *PostApprovalsAPIService) UnapprovePostExecute(r ApiUnapprovePostRequest) (*http.Response, error) {
	var (

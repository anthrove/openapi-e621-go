...
type ApiCreatePostDisapprovalRequest struct {
	ctx context.Context
...
func (r ApiCreatePostDisapprovalRequest) PostDisapprovalPostId(postDisapprovalPostId float32) ApiCreatePostDisapprovalRequest {
	r.postDisapprovalPostId = &postDisapprovalPostId
	return r
}

func (r ApiCreatePostDisapprovalRequest) PostDisapprovalReason(postDisapprovalReason string) ApiCreatePostDisapprovalRequest {
	r.postDisapprovalReason = &postDisapprovalReason
	return r
}

func (r ApiCreatePostDisapprovalRequest) PostDisapprovalMessage(postDisapprovalMessage string) ApiCreatePostDisapprovalRequest {
	r.postDisapprovalMessage = &postDisapprovalMessage
	return r
}

func (r ApiCreatePostDisapprovalRequest) Execute() (*PostDisapproval, *http.Response, error) {
...
You must have the "Approve Posts" permission.
 ...
 @return ApiCreatePostDisapprovalRequest
*/
func (a *PostDisapprovalsAPIService) CreatePostDisapproval(ctx context.Context) ApiCreatePostDisapprovalRequest {
	return ApiCreatePostDisapprovalRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PostDisapprovalsAPIService) CreatePostDisapprovalExecute(r ApiCreatePostDisapprovalRequest) (*PostDisapproval, *http.Response, error) {
	var (
...
type ApiSearchPostDisapprovalsRequest struct {
	ctx context.Context
	ApiService *PostDisapprovalsAPIService
	limit *float32
	page *float32
...
func (r ApiSearchPostDisapprovalsRequest) Limit(limit float32) ApiSearchPostDisapprovalsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchPostDisapprovalsRequest) Page(page float32) ApiSearchPostDisapprovalsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchPostDisapprovalsRequest) SearchId(searchId float32) ApiSearchPostDisapprovalsRequest {
	r.searchId = &searchId
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchOrder(searchOrder string) ApiSearchPostDisapprovalsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchCreatorId(searchCreatorId float32) ApiSearchPostDisapprovalsRequest {
	r.searchCreatorId = &searchCreatorId
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchCreatorName(searchCreatorName string) ApiSearchPostDisapprovalsRequest {
	r.searchCreatorName = &searchCreatorName
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchPostId(searchPostId float32) ApiSearchPostDisapprovalsRequest {
	r.searchPostId = &searchPostId
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchMessage(searchMessage string) ApiSearchPostDisapprovalsRequest {
	r.searchMessage = &searchMessage
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchPostTagsMatch(searchPostTagsMatch string) ApiSearchPostDisapprovalsRequest {
	r.searchPostTagsMatch = &searchPostTagsMatch
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchReason(searchReason string) ApiSearchPostDisapprovalsRequest {
	r.searchReason = &searchReason
	return r
}

func (r ApiSearchPostDisapprovalsRequest) SearchHasMessage(searchHasMessage bool) ApiSearchPostDisapprovalsRequest {
	r.searchHasMessage = &searchHasMessage
	return r
}

func (r ApiSearchPostDisapprovalsRequest) Execute() (*SearchPostDisapprovals200Response, *http.Response, error) {
...
You must have the "Approve Posts" permission When no results are found, an object with a `post_disapprovals` key is returned.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchPostDisapprovalsRequest
*/
func (a *PostDisapprovalsAPIService) SearchPostDisapprovals(ctx context.Context) ApiSearchPostDisapprovalsRequest {
	return ApiSearchPostDisapprovalsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PostDisapprovalsAPIService) SearchPostDisapprovalsExecute(r ApiSearchPostDisapprovalsRequest) (*SearchPostDisapprovals200Response, *http.Response, error) {
	var (

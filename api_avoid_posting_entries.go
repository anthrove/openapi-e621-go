...
type ApiCreateAvoidPostingRequest struct {
	ctx context.Context
...
func (r ApiCreateAvoidPostingRequest) AvoidPostingDetails(avoidPostingDetails string) ApiCreateAvoidPostingRequest {
	r.avoidPostingDetails = &avoidPostingDetails
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingStaffNotes(avoidPostingStaffNotes string) ApiCreateAvoidPostingRequest {
	r.avoidPostingStaffNotes = &avoidPostingStaffNotes
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingIsActive(avoidPostingIsActive bool) ApiCreateAvoidPostingRequest {
	r.avoidPostingIsActive = &avoidPostingIsActive
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesId(avoidPostingArtistAttributesId float32) ApiCreateAvoidPostingRequest {
...
func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesName(avoidPostingArtistAttributesName string) ApiCreateAvoidPostingRequest {
	r.avoidPostingArtistAttributesName = &avoidPostingArtistAttributesName
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesOtherNamesString(avoidPostingArtistAttributesOtherNamesString string) ApiCreateAvoidPostingRequest {
	r.avoidPostingArtistAttributesOtherNamesString = &avoidPostingArtistAttributesOtherNamesString
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesOtherNames(avoidPostingArtistAttributesOtherNames []string) ApiCreateAvoidPostingRequest {
	r.avoidPostingArtistAttributesOtherNames = &avoidPostingArtistAttributesOtherNames
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesGroupName(avoidPostingArtistAttributesGroupName string) ApiCreateAvoidPostingRequest {
	r.avoidPostingArtistAttributesGroupName = &avoidPostingArtistAttributesGroupName
	return r
}

func (r ApiCreateAvoidPostingRequest) AvoidPostingArtistAttributesLinkedUserId(avoidPostingArtistAttributesLinkedUserId float32) ApiCreateAvoidPostingRequest {
	r.avoidPostingArtistAttributesLinkedUserId = &avoidPostingArtistAttributesLinkedUserId
	return r
}

func (r ApiCreateAvoidPostingRequest) Execute() (*AvoidPosting, *http.Response, error) {
...
Must have the bd staff user flag. When no results are found, an object with an `avoid_posting_versions` key is returned.
 ...
 @return ApiCreateAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) CreateAvoidPosting(ctx context.Context) ApiCreateAvoidPostingRequest {
	return ApiCreateAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return AvoidPosting
func (a *AvoidPostingEntriesAPIService) CreateAvoidPostingExecute(r ApiCreateAvoidPostingRequest) (*AvoidPosting, *http.Response, error) {
	var (
...
type ApiDeleteAvoidPostingRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	idOrArtistName string
}

func (r ApiDeleteAvoidPostingRequest) Execute() (*http.Response, error) {
...
Must have the bd staff user flag.
 ...
 @return ApiDeleteAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) DeleteAvoidPosting(ctx context.Context, idOrArtistName string) ApiDeleteAvoidPostingRequest {
	return ApiDeleteAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
func (a *AvoidPostingEntriesAPIService) DeleteAvoidPostingExecute(r ApiDeleteAvoidPostingRequest) (*http.Response, error) {
	var (
...
type ApiDestroyAvoidPostingRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	idOrArtistName string
}

func (r ApiDestroyAvoidPostingRequest) Execute() (*http.Response, error) {
...
Must have the bd staff user flag.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param idOrArtistName The ID of the avoid posting entry, or the name of the artist.
 @return ApiDestroyAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) DestroyAvoidPosting(ctx context.Context, idOrArtistName string) ApiDestroyAvoidPostingRequest {
	return ApiDestroyAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
		idOrArtistName: idOrArtistName,
...
// Execute executes the request
func (a *AvoidPostingEntriesAPIService) DestroyAvoidPostingExecute(r ApiDestroyAvoidPostingRequest) (*http.Response, error) {
	var (
...
type ApiEditAvoidPostingRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	idOrArtistName string
	avoidPostingDetails *string
...
func (r ApiEditAvoidPostingRequest) AvoidPostingDetails(avoidPostingDetails string) ApiEditAvoidPostingRequest {
	r.avoidPostingDetails = &avoidPostingDetails
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingStaffNotes(avoidPostingStaffNotes string) ApiEditAvoidPostingRequest {
	r.avoidPostingStaffNotes = &avoidPostingStaffNotes
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingIsActive(avoidPostingIsActive bool) ApiEditAvoidPostingRequest {
	r.avoidPostingIsActive = &avoidPostingIsActive
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingArtistAttributesName(avoidPostingArtistAttributesName string) ApiEditAvoidPostingRequest {
	r.avoidPostingArtistAttributesName = &avoidPostingArtistAttributesName
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingArtistAttributesOtherNamesString(avoidPostingArtistAttributesOtherNamesString string) ApiEditAvoidPostingRequest {
	r.avoidPostingArtistAttributesOtherNamesString = &avoidPostingArtistAttributesOtherNamesString
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingArtistAttributesOtherNames(avoidPostingArtistAttributesOtherNames []string) ApiEditAvoidPostingRequest {
	r.avoidPostingArtistAttributesOtherNames = &avoidPostingArtistAttributesOtherNames
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingArtistAttributesGroupName(avoidPostingArtistAttributesGroupName string) ApiEditAvoidPostingRequest {
	r.avoidPostingArtistAttributesGroupName = &avoidPostingArtistAttributesGroupName
	return r
}

func (r ApiEditAvoidPostingRequest) AvoidPostingArtistAttributesLinkedUserId(avoidPostingArtistAttributesLinkedUserId float32) ApiEditAvoidPostingRequest {
	r.avoidPostingArtistAttributesLinkedUserId = &avoidPostingArtistAttributesLinkedUserId
	return r
}

func (r ApiEditAvoidPostingRequest) Execute() (*AvoidPosting, *http.Response, error) {
...
Must have the bd staff user flag.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param idOrArtistName The ID of the avoid posting entry, or the name of the artist.
 @return ApiEditAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) EditAvoidPosting(ctx context.Context, idOrArtistName string) ApiEditAvoidPostingRequest {
	return ApiEditAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
		idOrArtistName: idOrArtistName,
...
// Execute executes the request
//  @return AvoidPosting
func (a *AvoidPostingEntriesAPIService) EditAvoidPostingExecute(r ApiEditAvoidPostingRequest) (*AvoidPosting, *http.Response, error) {
	var (
...
type ApiGetAvoidPostingRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	idOrArtistName string
}

func (r ApiGetAvoidPostingRequest) Execute() (*AvoidPosting, *http.Response, error) {
...
GetAvoidPosting Get Avoid Posting Entry
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param idOrArtistName The ID of the avoid posting entry, or the name of the artist.
 @return ApiGetAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) GetAvoidPosting(ctx context.Context, idOrArtistName string) ApiGetAvoidPostingRequest {
	return ApiGetAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
		idOrArtistName: idOrArtistName,
...
// Execute executes the request
//  @return AvoidPosting
func (a *AvoidPostingEntriesAPIService) GetAvoidPostingExecute(r ApiGetAvoidPostingRequest) (*AvoidPosting, *http.Response, error) {
	var (
...
type ApiSearchAvoidPostingsRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	limit *float32
	page *float32
...
func (r ApiSearchAvoidPostingsRequest) Limit(limit float32) ApiSearchAvoidPostingsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchAvoidPostingsRequest) Page(page float32) ApiSearchAvoidPostingsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchAvoidPostingsRequest) SearchId(searchId float32) ApiSearchAvoidPostingsRequest {
	r.searchId = &searchId
	return r
}
...
func (r ApiSearchAvoidPostingsRequest) SearchIpAddr(searchIpAddr string) ApiSearchAvoidPostingsRequest {
	r.searchIpAddr = &searchIpAddr
	return r
}

func (r ApiSearchAvoidPostingsRequest) SearchOrder(searchOrder string) ApiSearchAvoidPostingsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchAvoidPostingsRequest) SearchCreatorName(searchCreatorName string) ApiSearchAvoidPostingsRequest {
	r.searchCreatorName = &searchCreatorName
	return r
}

func (r ApiSearchAvoidPostingsRequest) SearchCreatorId(searchCreatorId string) ApiSearchAvoidPostingsRequest {
	r.searchCreatorId = &searchCreatorId
	return r
}

// Any name matching.
func (r ApiSearchAvoidPostingsRequest) SearchAnyNameMatches(searchAnyNameMatches string) ApiSearchAvoidPostingsRequest {
	r.searchAnyNameMatches = &searchAnyNameMatches
	return r
}

// The artist name of the avoid posting entry.
func (r ApiSearchAvoidPostingsRequest) SearchArtistName(searchArtistName string) ApiSearchAvoidPostingsRequest {
	r.searchArtistName = &searchArtistName
	return r
}

// The artist id for the avoid posting entry.
func (r ApiSearchAvoidPostingsRequest) SearchArtistId(searchArtistId string) ApiSearchAvoidPostingsRequest {
	r.searchArtistId = &searchArtistId
	return r
}

// Any other name matching.
func (r ApiSearchAvoidPostingsRequest) SearchAnyOtherNameMatches(searchAnyOtherNameMatches string) ApiSearchAvoidPostingsRequest {
	r.searchAnyOtherNameMatches = &searchAnyOtherNameMatches
	return r
}

// The details of the avoid posting entry.
func (r ApiSearchAvoidPostingsRequest) SearchDetails(searchDetails string) ApiSearchAvoidPostingsRequest {
	r.searchDetails = &searchDetails
	return r
}

// The staff notes on the avoid posting entry. Must be Janitor+ to use.
func (r ApiSearchAvoidPostingsRequest) SearchStaffNotes(searchStaffNotes string) ApiSearchAvoidPostingsRequest {
	r.searchStaffNotes = &searchStaffNotes
	return r
}

// If the avoid posting entry is active.
func (r ApiSearchAvoidPostingsRequest) SearchIsActive(searchIsActive bool) ApiSearchAvoidPostingsRequest {
	r.searchIsActive = &searchIsActive
	return r
}

func (r ApiSearchAvoidPostingsRequest) Execute() (*SearchAvoidPostings200Response, *http.Response, error) {
...
When no results are found, an object with an `avoid_postings` key is returned.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchAvoidPostingsRequest
*/
func (a *AvoidPostingEntriesAPIService) SearchAvoidPostings(ctx context.Context) ApiSearchAvoidPostingsRequest {
	return ApiSearchAvoidPostingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AvoidPostingEntriesAPIService) SearchAvoidPostingsExecute(r ApiSearchAvoidPostingsRequest) (*SearchAvoidPostings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiUndeleteAvoidPostingRequest struct {
	ctx context.Context
	ApiService *AvoidPostingEntriesAPIService
	idOrArtistName string
}

func (r ApiUndeleteAvoidPostingRequest) Execute() (*http.Response, error) {
...
Must have the bd staff user flag.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param idOrArtistName The ID of the avoid posting entry, or the name of the artist.
 @return ApiUndeleteAvoidPostingRequest
*/
func (a *AvoidPostingEntriesAPIService) UndeleteAvoidPosting(ctx context.Context, idOrArtistName string) ApiUndeleteAvoidPostingRequest {
	return ApiUndeleteAvoidPostingRequest{
		ApiService: a,
		ctx: ctx,
		idOrArtistName: idOrArtistName,
...
// Execute executes the request
func (a *AvoidPostingEntriesAPIService) UndeleteAvoidPostingExecute(r ApiUndeleteAvoidPostingRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile

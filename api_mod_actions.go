...
type ApiSearchModActionsRequest struct {
	ctx context.Context
...
func (r ApiSearchModActionsRequest) Limit(limit float32) ApiSearchModActionsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ApiSearchModActionsRequest) Page(page float32) ApiSearchModActionsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ApiSearchModActionsRequest) SearchId(searchId float32) ApiSearchModActionsRequest {
	r.searchId = &searchId
	return r
}

func (r ApiSearchModActionsRequest) SearchOrder(searchOrder string) ApiSearchModActionsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ApiSearchModActionsRequest) SearchCreatorId(searchCreatorId float32) ApiSearchModActionsRequest {
	r.searchCreatorId = &searchCreatorId
	return r
}

func (r ApiSearchModActionsRequest) SearchCreatorName(searchCreatorName string) ApiSearchModActionsRequest {
	r.searchCreatorName = &searchCreatorName
	return r
}

func (r ApiSearchModActionsRequest) SearchAction(searchAction ModactionActions) ApiSearchModActionsRequest {
	r.searchAction = &searchAction
	return r
}

func (r ApiSearchModActionsRequest) Execute() ([]ModAction, *http.Response, error) {
...
* `post_replacement_accept`, `post_replacement_reject`, `post_replacement_delete`
 ...
 @return ApiSearchModActionsRequest
*/
func (a *ModActionsAPIService) SearchModActions(ctx context.Context) ApiSearchModActionsRequest {
	return ApiSearchModActionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []ModAction
func (a *ModActionsAPIService) SearchModActionsExecute(r ApiSearchModActionsRequest) ([]ModAction, *http.Response, error) {
	var (

...
type ArtistsAPICreateArtistRequest struct {
	ctx                    context.Context
...
func (r ArtistsAPICreateArtistRequest) ArtistName(artistName string) ArtistsAPICreateArtistRequest {
	r.artistName = &artistName
	return r
}

func (r ArtistsAPICreateArtistRequest) ArtistOtherNames(artistOtherNames []string) ArtistsAPICreateArtistRequest {
	r.artistOtherNames = &artistOtherNames
	return r
}

func (r ArtistsAPICreateArtistRequest) ArtistOtherNamesString(artistOtherNamesString string) ArtistsAPICreateArtistRequest {
	r.artistOtherNamesString = &artistOtherNamesString
	return r
}

func (r ArtistsAPICreateArtistRequest) ArtistUrlString(artistUrlString string) ArtistsAPICreateArtistRequest {
	r.artistUrlString = &artistUrlString
	return r
}

func (r ArtistsAPICreateArtistRequest) ArtistNotes(artistNotes string) ArtistsAPICreateArtistRequest {
	r.artistNotes = &artistNotes
	return r
}

func (r ArtistsAPICreateArtistRequest) ArtistGroupName(artistGroupName string) ArtistsAPICreateArtistRequest {
	r.artistGroupName = &artistGroupName
	return r
}

// Only usable for Janitor+
func (r ArtistsAPICreateArtistRequest) ArtistLinkedUserId(artistLinkedUserId float32) ArtistsAPICreateArtistRequest {
	r.artistLinkedUserId = &artistLinkedUserId
	return r
}

// Only usable for Janitor+
func (r ArtistsAPICreateArtistRequest) ArtistIsLocked(artistIsLocked bool) ArtistsAPICreateArtistRequest {
	r.artistIsLocked = &artistIsLocked
	return r
}

func (r ArtistsAPICreateArtistRequest) Execute() (*Artist, *http.Response, error) {
...
Individual `other_names` are silently truncated to 100 characters.
	...
	@return ArtistsAPICreateArtistRequest
*/
func (a *ArtistsAPIService) CreateArtist(ctx context.Context) ArtistsAPICreateArtistRequest {
	return ArtistsAPICreateArtistRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Artist
func (a *ArtistsAPIService) CreateArtistExecute(r ArtistsAPICreateArtistRequest) (*Artist, *http.Response, error) {
	var (
...
type ArtistsAPIDeleteArtistRequest struct {
	ctx        context.Context
	ApiService *ArtistsAPIService
	idOrName   GetArtistIdOrNameParameter
}

func (r ArtistsAPIDeleteArtistRequest) Execute() (*http.Response, error) {
...
You must be an Admin+ to delete an artist.
	...
	@return ArtistsAPIDeleteArtistRequest
*/
func (a *ArtistsAPIService) DeleteArtist(ctx context.Context, idOrName GetArtistIdOrNameParameter) ArtistsAPIDeleteArtistRequest {
	return ArtistsAPIDeleteArtistRequest{
		ApiService: a,
		ctx:        ctx,
		idOrName:   idOrName,
...
// Execute executes the request
func (a *ArtistsAPIService) DeleteArtistExecute(r ArtistsAPIDeleteArtistRequest) (*http.Response, error) {
	var (
...
type ArtistsAPIEditArtistRequest struct {
	ctx               context.Context
	ApiService        *ArtistsAPIService
	idOrName          GetArtistIdOrNameParameter
...
func (r ArtistsAPIEditArtistRequest) EditArtistRequest(editArtistRequest EditArtistRequest) ArtistsAPIEditArtistRequest {
	r.editArtistRequest = &editArtistRequest
	return r
}

func (r ArtistsAPIEditArtistRequest) Execute() (*http.Response, error) {
...
If an artist is on the avoid posting list, you must have the bd staff user flag to edit name, other_names, or group_name.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param idOrName The ID or name of the artist to edit.
	@return ArtistsAPIEditArtistRequest
*/
func (a *ArtistsAPIService) EditArtist(ctx context.Context, idOrName GetArtistIdOrNameParameter) ArtistsAPIEditArtistRequest {
	return ArtistsAPIEditArtistRequest{
		ApiService: a,
		ctx:        ctx,
		idOrName:   idOrName,
...
// Execute executes the request
func (a *ArtistsAPIService) EditArtistExecute(r ArtistsAPIEditArtistRequest) (*http.Response, error) {
	var (
...
type ArtistsAPIGetArtistRequest struct {
	ctx        context.Context
	ApiService *ArtistsAPIService
	idOrName   GetArtistIdOrNameParameter
}

func (r ArtistsAPIGetArtistRequest) Execute() (*GetArtist200Response, *http.Response, error) {
...
GetArtist Get Artist
	...
	@return ArtistsAPIGetArtistRequest
*/
func (a *ArtistsAPIService) GetArtist(ctx context.Context, idOrName GetArtistIdOrNameParameter) ArtistsAPIGetArtistRequest {
	return ArtistsAPIGetArtistRequest{
		ApiService: a,
		ctx:        ctx,
		idOrName:   idOrName,
...
func (a *ArtistsAPIService) GetArtistExecute(r ArtistsAPIGetArtistRequest) (*GetArtist200Response, *http.Response, error) {
	var (
...
type ArtistsAPIRevertArtistRequest struct {
	ctx        context.Context
	ApiService *ArtistsAPIService
	idOrName   GetArtistIdOrNameParameter
	versionId  *int32
...
func (r ArtistsAPIRevertArtistRequest) Execute() (*http.Response, error) {
...
If an artist is locked, you must be Janitor+ to revert them.
	...
	@return ArtistsAPIRevertArtistRequest
*/
func (a *ArtistsAPIService) RevertArtist(ctx context.Context, idOrName GetArtistIdOrNameParameter) ArtistsAPIRevertArtistRequest {
	return ArtistsAPIRevertArtistRequest{
		ApiService: a,
		ctx:        ctx,
		idOrName:   idOrName,
...
// Execute executes the request
func (a *ArtistsAPIService) RevertArtistExecute(r ArtistsAPIRevertArtistRequest) (*http.Response, error) {
	var (
...
type ArtistsAPISearchArtistsRequest struct {
	ctx                       context.Context
	ApiService                *ArtistsAPIService
	limit                     *int32
	page                      *int32
...
func (r ArtistsAPISearchArtistsRequest) Limit(limit int32) ArtistsAPISearchArtistsRequest {
	r.limit = &limit
	return r
}

// The page number of results to get. Between 1 and 750.
func (r ArtistsAPISearchArtistsRequest) Page(page int32) ArtistsAPISearchArtistsRequest {
	r.page = &page
	return r
}

// Search for a specific id.
func (r ArtistsAPISearchArtistsRequest) SearchId(searchId int32) ArtistsAPISearchArtistsRequest {
	r.searchId = &searchId
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchOrder(searchOrder string) ArtistsAPISearchArtistsRequest {
	r.searchOrder = &searchOrder
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchName(searchName string) ArtistsAPISearchArtistsRequest {
	r.searchName = &searchName
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchGroupName(searchGroupName string) ArtistsAPISearchArtistsRequest {
	r.searchGroupName = &searchGroupName
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchAnyOtherNameLike(searchAnyOtherNameLike string) ArtistsAPISearchArtistsRequest {
	r.searchAnyOtherNameLike = &searchAnyOtherNameLike
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchAnyNameMatches(searchAnyNameMatches string) ArtistsAPISearchArtistsRequest {
	r.searchAnyNameMatches = &searchAnyNameMatches
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchAnyNameOrUrlMatches(searchAnyNameOrUrlMatches string) ArtistsAPISearchArtistsRequest {
	r.searchAnyNameOrUrlMatches = &searchAnyNameOrUrlMatches
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchUrlMatches(searchUrlMatches string) ArtistsAPISearchArtistsRequest {
	r.searchUrlMatches = &searchUrlMatches
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchCreatorName(searchCreatorName string) ArtistsAPISearchArtistsRequest {
	r.searchCreatorName = &searchCreatorName
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchCreatorId(searchCreatorId string) ArtistsAPISearchArtistsRequest {
	r.searchCreatorId = &searchCreatorId
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchHasTag(searchHasTag string) ArtistsAPISearchArtistsRequest {
	r.searchHasTag = &searchHasTag
	return r
}

func (r ArtistsAPISearchArtistsRequest) SearchIsLinked(searchIsLinked string) ArtistsAPISearchArtistsRequest {
	r.searchIsLinked = &searchIsLinked
	return r
}

func (r ArtistsAPISearchArtistsRequest) Execute() ([]SearchArtists200ResponseInner, *http.Response, error) {
...
SearchArtists Search Artists
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ArtistsAPISearchArtistsRequest
*/
func (a *ArtistsAPIService) SearchArtists(ctx context.Context) ArtistsAPISearchArtistsRequest {
	return ArtistsAPISearchArtistsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ArtistsAPIService) SearchArtistsExecute(r ArtistsAPISearchArtistsRequest) ([]SearchArtists200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
